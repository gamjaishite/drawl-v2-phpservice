...
VALUES ('1a2b3c', 'John Doe', 'password123', 'john@example.com', 'BASIC', NOW(), NOW()),
...
VALUES ('abc123', 'Anime Show 1', 'Description 1', 'poster1.jpg', 'trailer1.mp4', 'ANIME', NOW(), NOW()),
...
VALUES ('wxyz123', 'My Watchlist 1', 'Watchlist description 1', 'MIXED', 1, 0, 'PRIVATE', NOW(), NOW()),
...
VALUES ('comment1', 'This is a comment.', 1, NOW()),
...
-- QUERY PLAN GET WATCHLISTS

-- 1. PAGINATE WATCHLISTS
SELECT
FROM
    users AS u JOIN
        (SELECT
        ...
        FROM
            watchlist
        LIMIT 20
        OFFSET 20) as w ON u.id = w.user_id
